...
HD_PWD='C:/Users/Kirollosfady/Downloads/8-8_SPM/dd1_Final_Project/dd1_Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_control_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_control_unit.tcl -notrace
